...
# Part 3) Check that the date entered is an acceptable date    
...
# Part 4) Find the all blocks on the target day or in block height range requested
...
#  Part 7) Construct the USD price finder stencils
...
#  Part 8) Estimate a rough price using the best fit stencil slide
...
#  Part 9) Convert all outputs near round USD to the USD price used in the output
...
#  Part 10) Find the central output and average deviation for plot window
...
#  Part 11) Generate the chart in a webpage and serve it to the browser
